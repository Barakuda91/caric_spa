...
module.exports = {
  getFiltersArray: function(filterType) {
    var filters = {}
    if (sails.config.caric.advertSettingParamFilters[filterType]) {
      for (var key in sails.config.caric.advertSettingParamFilters[filterType]) {
        filters[sails.config.caric.advertSettingParamFilters[filterType][key]] = true;
      }
    }
    return filters;
  },
